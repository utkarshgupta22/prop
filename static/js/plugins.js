    ...
    function c(g) {
      g.after(
        a("<div></div>")
          ...
          .addClass(g.attr("class") || "")
          .addClass(g.attr("disabled") ? "disabled" : "")
          .addClass(g.attr("multiple") ? "has-multiple" : "")
          .attr("tabindex", g.attr("disabled") ? null : "0")
          .html(
            g.attr("multiple")
    ...
    a(document).on(
      ...
      function (e) {
        ...
        if (f.hasClass("has-multiple")) {
          ...
          $select_placeholder =
            f.prev("select").data("placeholder") ||
            f.prev("select").attr("placeholder");
          $select_placeholder =
            $select_placeholder == "" ? "Select" : $select_placeholder;
          $selected_html =
